      ...
      <div className="w-full max-w-sm mx-4 relative">
        <div className="rounded-2xl bg-white/70 dark:bg-zinc-900/50 backdrop-blur-xl border border-zinc-200/50 dark:border-zinc-700/30 shadow-xl shadow-zinc-200/50 dark:shadow-zinc-950 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="register-username" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Username</label>
              <input
            ...
            <div>
              <label htmlFor="register-password" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5">Password</label>
              <input
          ...
          <p className="mt-6 text-center text-sm text-zinc-500 dark:text-zinc-400">
            ...
            <Link to="/login" className="text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 font-medium transition-colors">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
